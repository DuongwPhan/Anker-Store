  ...
  <header role="banner">
    ...
    <div id="header">   
      ...
      <div class="middle-header">
        <div class="container">
          <div class="row">
            <div class="logo col-lg-3 col-md-3 py-2">
            ...
            <div class="account col-lg-1 col-md-1 col-4 mx-lg-0 my-md-4 m-3">
            ...
            <div class="col-lg-2 col-md-2 col-6 cart_icon mx-lg-0 p-md-0 my-md-3 my-1">
              <?php if(class_exists('woocommerce')){ ?>
